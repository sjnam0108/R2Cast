...
<c:url value="/eco/common/updateOpTag" var="updateOpTagUrl" />
...
function attachRvmStatusBarPopover() {
	$('.rvm-status-popover').popover({
	    ...
	    content: function(){
	        ...
	        return popoverContent(kendo.format("/eco/common/rvmstatus?rvmId={0}", 
...
$(document).ready(function() {
	$("#deviceOverviewModal").on('show.bs.modal', function (e) {
		...
		if (rvmOverviewDate) {
			...
			$("#deviceOverviewModal .modal-body").load("/eco/common/rvmoverview?id=" + 
