    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header move-cursor"">
                <h5 class="modal-title">RVM 최근 작업</h5>
...
$(document).ready(function() {
	$('#recentTaskModal').on('show.bs.modal', function (e) {
	    ...
	    $(this).find('.modal-body').load("/eco/common/recenttask");
	...
	$("#recent-task-btn").click(function() {
	    $("#recentTaskModal .modal-body").html("<div class='d-flex align-items-center justify-content-center py-4'>잠시 기다려 주십시오</div>");
